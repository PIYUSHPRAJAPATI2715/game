...
class TieAddMoneyPopup extends StatefulWidget {
  const TieAddMoneyPopup({Key? key}) : super(key: key);

  @override
  State<TieAddMoneyPopup> createState() => _TieAddMoneyPopupState();
}

class _TieAddMoneyPopupState extends State<TieAddMoneyPopup> {
